...
//		runners.add(new HouseConstructionBatchF("Batch-F"));
		runners.add(new HouseConstructionBatchG("Batch-G"));
...
//			generator.reqPerTask = ScenarioGenerator.mkRange(4, 8);
			...
			/*	Upper Limit for the Incremental evaluation Scenario for Runners using BATCH-G, which will not find all optimal solutions.
			 *  generator.offerSplitRate = 0.0;
			 *  generator.additionalOfferRate = 0.4;	
			 *  generator.scale(10, 1, 0, 6, 0, 5, 0);
			 */
			generator.scale(10, 1, 0, 10, 0, 10, 0);
