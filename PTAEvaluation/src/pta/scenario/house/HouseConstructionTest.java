...
//		runners.add(new HouseConstructionBatchE("Batch-E"));
		...
		runners.forEach(runner -> {
			...
			/*
			 * Config and upper Limit for the Batch evaluation Scenario for Runners using
			 * BATCH-A through E generator.offerSplitRate = 0.5;
			 * generator.additionalOfferRate = 0.2; generator.scale(10, 1, 0, 6, 0, 5, 0);
			 */

			/*
			 * Upper Limit for the Incremental evaluation Scenario for Runners using
			 * BATCH-A, BATCH-F and BATCH-G, where the two latter of which will not find all
			 * optimal solutions. generator.offerSplitRate = 0.0;
			 * generator.additionalOfferRate = 0.25; generator.scale(10, 1, 0, 5, 0, 30, 0);
			 */
			int scale = 2;
			int run = 4;
