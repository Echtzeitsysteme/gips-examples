...
public record EvaluationResult(String id, ScenarioValidator validator, SolverOutput output,
	...
	public final String toString() {
		...
		sb.append("Total: "
				+ (validator.getNumberOfProjects() + validator.getNumberOfTasks() + validator.getNumberOfRequirements()
						+ validator.getNumberOfPersons() + validator.getNumberOfOffers() + validator.getNumberOfWeeks())
				+ "\n");
		...
		for (var measurement : measurements.entrySet()) {
			sb.append(
					"[" + measurement.getKey() + ": " + measurement.getValue().totalDurationSeconds() + "s(TOTAL)]\t");
