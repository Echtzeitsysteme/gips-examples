...
public class EvaluationGenerator {
	...
	public static String[] batchRunnerTypes = { HouseConstructionBatchA.TYPE, HouseConstructionBatchB.TYPE,
			HouseConstructionBatchC.TYPE, HouseConstructionBatchD.TYPE, HouseConstructionBatchE.TYPE, };
	public static String[] incRunnerTypes = { HouseConstructionBatchA.TYPE, HouseConstructionIncF.TYPE,
	...
	public static void main(String[] args) {
		...
		// Generate Batch
		final Option batchScaling = new Option("b", "batch", true,
				"Upper scaling of batch scenarios. Set to 0 to create not batch scenarios.");
		batchScaling.setRequired(true);
		options.addOption(batchScaling);

		// Generate Incremental
		final Option incrementalScaling = new Option("i", "incremental", true,
				"Upper scaling of incremental scenarios. Set to 0 to create not incremental scenarios.");
		...
		for (int i = 1; i <= batchUpper; i++) {
			...
			String script = EvaluationScriptGenerator.genExecutionScript(runScript, src, trg, id,
