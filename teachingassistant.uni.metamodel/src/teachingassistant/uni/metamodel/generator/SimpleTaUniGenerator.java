 ...
 * </ul>
 */
public class SimpleTaUniGenerator extends TeachingAssistantUniGenerator {

	/**
	 * Logger for system outputs.
	 */
	protected final static Logger logger = Logger.getLogger(SimpleTaUniGenerator.class.getName());
...
//	static int[] POSSIBLE_START_HOURS = { 9, 11, 13, 15 };
	 ...
	 */
	public SimpleTaUniGenerator(int seed) {
		LoggingUtils.configureLogging(logger);
		rand = new Random(seed);
	}

	public static void main(final String[] args) {
		final SimpleTaUniGenerator gen = new SimpleTaUniGenerator(0);
		...
		// Save as XMI
		try {
			save(model, instanceFolderPath + "/uni_ta_allocation.xmi");
		...
		exporter.modelToJson(instanceFolderPath + "/uni_ta_allocation.json");
