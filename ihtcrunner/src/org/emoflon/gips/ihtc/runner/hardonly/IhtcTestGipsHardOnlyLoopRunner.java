 ...
 */
public class IhtcTestGipsHardOnlyLoopRunner extends AbstractIhtcGipsHardOnlyLoopRunner {

	/**
	 * No public instances of this class allowed.
	 */
	private IhtcTestGipsHardOnlyLoopRunner() {
		super();
	}
	...
	public static void main(final String[] args) {
		final IhtcTestGipsHardOnlyLoopRunner runner = new IhtcTestGipsHardOnlyLoopRunner();
