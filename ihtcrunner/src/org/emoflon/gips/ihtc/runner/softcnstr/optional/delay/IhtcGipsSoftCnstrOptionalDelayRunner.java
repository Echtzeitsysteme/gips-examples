 ...
 */
public class IhtcGipsSoftCnstrOptionalDelayRunner extends IhtcGipsRunner {
	...
	public void run() {
		...
		// Output JSON file
		final String datasetSolutionFolder = projectFolder + "/../ihtcmetamodel/resources/soft_cnstr_optional_delay/";
