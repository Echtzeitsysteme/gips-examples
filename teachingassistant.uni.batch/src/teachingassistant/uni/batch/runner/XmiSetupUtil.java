...
public class XmiSetupUtil {
	...
	public static void checkIfEclipseOrJarSetup(final GipsEngineAPI<?, ?> gipsApi, final String modelPath) {
		...
		if (gipsApi instanceof BatchGipsAPI) {
			setup( //
					gipsApi, //
					"./teachingassistant/uni/batch/hipe/engine/hipe-network.xmi", //
					"teachingassistant.uni.batch.hipe.engine.HiPEEngine", //
					"./teachingassistant/uni/batch/api/gips/gips-model.xmi", //
					modelPath, //
					"./teachingassistant/uni/batch/api/ibex-patterns.xmi" //
			);
		} else {
