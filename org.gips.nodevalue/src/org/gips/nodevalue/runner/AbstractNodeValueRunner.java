...
public abstract class AbstractNodeValueRunner {
	 ...
	 */
	protected void gipsSave(final NodevalueGipsAPI gipsApi, final String path) {
		try {
	 ...
	 */
	protected double buildAndSolve(final NodevalueGipsAPI gipsApi) {
	...
	/**
	 * Applies the best found solution (aka all non-zero mappings) with a given Node
	 * Value GIPS API object.
	 * 
	 * @param gipsApi Node Value GIPS API object to get all mapping information
	 *                from.
	 */
