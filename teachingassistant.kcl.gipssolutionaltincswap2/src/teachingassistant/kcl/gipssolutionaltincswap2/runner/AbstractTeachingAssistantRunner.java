...
import teachingassistant.kcl.gipssolutionaltincswap2.api.gips.Gipssolutionaltincswap2GipsAPI;
...
public abstract class AbstractTeachingAssistantRunner {
	 ...
	 */
	protected void gipsSave(final Gipssolutionaltincswap2GipsAPI gipsApi, final String path) {
		try {
	 ...
	 */
	protected double buildAndSolve(final Gipssolutionaltincswap2GipsAPI gipsApi) {
	 ...
	 *                information from.
	 */
	protected void applySolution(final Gipssolutionaltincswap2GipsAPI gipsApi) {
