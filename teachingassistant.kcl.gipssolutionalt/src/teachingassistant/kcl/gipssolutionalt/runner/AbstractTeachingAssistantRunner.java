...
public abstract class AbstractTeachingAssistantRunner {
	 ...
	 */
	protected void gipsSave(final GipssolutionaltGipsAPI gipsApi, final String path) {
		try {
	 ...
	 */
	protected double buildAndSolve(final GipssolutionaltGipsAPI gipsApi) {
	 ...
	 *                information from.
	 */
	protected void applySolution(final GipssolutionaltGipsAPI gipsApi) {
