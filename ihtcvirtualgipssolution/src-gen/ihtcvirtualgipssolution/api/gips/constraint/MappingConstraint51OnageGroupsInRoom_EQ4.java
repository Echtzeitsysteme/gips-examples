...
public class MappingConstraint51OnageGroupsInRoom_EQ4 extends GipsMappingConstraint<IhtcvirtualgipssolutionGipsAPI, AgeGroupsInRoomMapping>{
	public MappingConstraint51OnageGroupsInRoom_EQ4(final IhtcvirtualgipssolutionGipsAPI engine, final MappingConstraint constraint) {
	...
	protected List<Term> buildVariableLhs(final AgeGroupsInRoomMapping context) {
		...
		terms.add(new Term(engine.getNonMappingVariable(context, "MappingConstraint51OnageGroupsInRoom_EQslack1"), builder_0(context)));
		return terms;
	}
