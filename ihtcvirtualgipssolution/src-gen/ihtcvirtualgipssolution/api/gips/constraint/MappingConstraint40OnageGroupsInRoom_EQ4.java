...
public class MappingConstraint40OnageGroupsInRoom_EQ4 extends GipsMappingConstraint<IhtcvirtualgipssolutionGipsAPI, AgeGroupsInRoomMapping>{
	public MappingConstraint40OnageGroupsInRoom_EQ4(final IhtcvirtualgipssolutionGipsAPI engine, final MappingConstraint constraint) {
	...
	protected List<Term> buildVariableLhs(final AgeGroupsInRoomMapping context) {
		...
		terms.add(new Term(engine.getNonMappingVariable(context, "MappingConstraint40OnageGroupsInRoom_EQslack1"), builder_0(context)));
		return terms;
	}
