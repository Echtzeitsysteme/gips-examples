...
public class MappingConstraint23OnassignedGenderToRoomOnShift extends GipsMappingConstraint<IhtcvirtualgipssolutionGipsAPI, AssignedGenderToRoomOnShiftMapping>{
	public MappingConstraint23OnassignedGenderToRoomOnShift(final IhtcvirtualgipssolutionGipsAPI engine, final MappingConstraint constraint) {
	...
	protected double builder_1(final AssignedGenderToRoomOnShiftMapping context) {
		return (-1.0) * ((1.0) * (1000));
	}
