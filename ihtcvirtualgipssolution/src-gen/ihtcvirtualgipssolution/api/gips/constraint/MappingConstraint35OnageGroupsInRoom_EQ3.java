...
public class MappingConstraint35OnageGroupsInRoom_EQ3 extends GipsMappingConstraint<IhtcvirtualgipssolutionGipsAPI, AgeGroupsInRoomMapping>{
	public MappingConstraint35OnageGroupsInRoom_EQ3(final IhtcvirtualgipssolutionGipsAPI engine, final MappingConstraint constraint) {
	...
	protected List<Term> buildVariableLhs(final AgeGroupsInRoomMapping context) {
		...
		terms.add(new Term(engine.getNonMappingVariable(context, "MappingConstraint35OnageGroupsInRoom_EQslack2"), builder_1(context)));
		return terms;
	}
