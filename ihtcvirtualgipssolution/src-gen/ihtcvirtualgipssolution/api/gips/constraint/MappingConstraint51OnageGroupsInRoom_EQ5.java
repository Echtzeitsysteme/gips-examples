...
public class MappingConstraint51OnageGroupsInRoom_EQ5 extends GipsMappingConstraint<IhtcvirtualgipssolutionGipsAPI, AgeGroupsInRoomMapping>{
	public MappingConstraint51OnageGroupsInRoom_EQ5(final IhtcvirtualgipssolutionGipsAPI engine, final MappingConstraint constraint) {
	...
	protected List<Term> buildVariableLhs(final AgeGroupsInRoomMapping context) {
		...
		terms.add(new Term(engine.getNonMappingVariable(context, "MappingConstraint51OnageGroupsInRoom_EQslack2"), builder_0(context)));
		return terms;
	}
