...
public class MappingConstraint35OnageGroupsInRoom_EQ1 extends GipsMappingConstraint<IhtcvirtualgipssolutionGipsAPI, AgeGroupsInRoomMapping>{
	public MappingConstraint35OnageGroupsInRoom_EQ1(final IhtcvirtualgipssolutionGipsAPI engine, final MappingConstraint constraint) {
	...
	protected List<Term> buildVariableLhs(final AgeGroupsInRoomMapping context) {
		...
		terms.add(new Term(engine.getNonMappingVariable(context, "MappingConstraint35OnageGroupsInRoom_EQslack1"), builder_1(context)));
		return terms;
	}
