...
public class MappingConstraint50OnageGroupsInRoom_EQ5 extends GipsMappingConstraint<IhtcvirtualgipssolutionGipsAPI, AgeGroupsInRoomMapping>{
	public MappingConstraint50OnageGroupsInRoom_EQ5(final IhtcvirtualgipssolutionGipsAPI engine, final MappingConstraint constraint) {
	...
	protected List<Term> buildVariableLhs(final AgeGroupsInRoomMapping context) {
		...
		terms.add(new Term(engine.getNonMappingVariable(context, "DisjunctMappingConstraint49OnageGroupsInRoom_symbolic0"), 1.0));
		terms.add(new Term(engine.getNonMappingVariable(context, "MappingConstraint50OnageGroupsInRoom_EQslack2"), builder_0(context)));
		return terms;
	}
