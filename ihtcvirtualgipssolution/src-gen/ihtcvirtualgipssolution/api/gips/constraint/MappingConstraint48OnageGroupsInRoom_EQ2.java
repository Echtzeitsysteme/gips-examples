...
public class MappingConstraint48OnageGroupsInRoom_EQ2 extends GipsMappingConstraint<IhtcvirtualgipssolutionGipsAPI, AgeGroupsInRoomMapping>{
	public MappingConstraint48OnageGroupsInRoom_EQ2(final IhtcvirtualgipssolutionGipsAPI engine, final MappingConstraint constraint) {
	...
	protected List<Term> buildVariableLhs(final AgeGroupsInRoomMapping context) {
		...
		terms.add(new Term(engine.getNonMappingVariable(context, "MappingConstraint48OnageGroupsInRoom_EQslack2"), builder_1(context)));
		return terms;
	}
