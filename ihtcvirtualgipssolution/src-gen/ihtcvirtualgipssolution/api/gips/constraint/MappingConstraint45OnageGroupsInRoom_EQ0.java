...
public class MappingConstraint45OnageGroupsInRoom_EQ0 extends GipsMappingConstraint<IhtcvirtualgipssolutionGipsAPI, AgeGroupsInRoomMapping>{
	public MappingConstraint45OnageGroupsInRoom_EQ0(final IhtcvirtualgipssolutionGipsAPI engine, final MappingConstraint constraint) {
	...
	protected List<Term> buildVariableLhs(final AgeGroupsInRoomMapping context) {
		...
		terms.add(new Term(engine.getNonMappingVariable(context, "MappingConstraint45OnageGroupsInRoom_EQslack1"), builder_1(context)));
		return terms;
	}
