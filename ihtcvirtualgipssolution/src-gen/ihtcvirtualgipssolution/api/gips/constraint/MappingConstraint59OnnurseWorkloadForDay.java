...
public class MappingConstraint59OnnurseWorkloadForDay extends GipsMappingConstraint<IhtcvirtualgipssolutionGipsAPI, NurseWorkloadForDayMapping>{
	public MappingConstraint59OnnurseWorkloadForDay(final IhtcvirtualgipssolutionGipsAPI engine, final MappingConstraint constraint) {
	...
	protected List<Term> buildVariableLhs(final NurseWorkloadForDayMapping context) {
		...
		terms.add(new Term(engine.getNonMappingVariable(context, "workloadDiff"), builder_0(context)));
		return terms;
	}
	...
	protected double builder_0(final NurseWorkloadForDayMapping context) {
		return (-1.0) * (1.0);
	}
}
