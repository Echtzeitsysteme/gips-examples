...
public class DisjunctMappingConstraint42OnageGroupsInRoom extends GipsMappingConstraint<IhtcvirtualgipssolutionGipsAPI, AgeGroupsInRoomMapping>{
	public DisjunctMappingConstraint42OnageGroupsInRoom(final IhtcvirtualgipssolutionGipsAPI engine, final MappingConstraint constraint) {
	...
	protected List<Term> buildVariableLhs(final AgeGroupsInRoomMapping context) {
		...
		terms.add(new Term(engine.getNonMappingVariable(context, "DisjunctMappingConstraint42OnageGroupsInRoom_symbolic1"), builder_0(context)));
		terms.add(new Term(engine.getNonMappingVariable(context, "DisjunctMappingConstraint42OnageGroupsInRoom_symbolic2"), builder_1(context)));
		terms.add(new Term(engine.getNonMappingVariable(context, "DisjunctMappingConstraint42OnageGroupsInRoom_symbolic0"), 1.0));
		return terms;
	}
