...
public class MappingConstraint44OnageGroupsInRoom_EQ5 extends GipsMappingConstraint<IhtcvirtualgipssolutionGipsAPI, AgeGroupsInRoomMapping>{
	public MappingConstraint44OnageGroupsInRoom_EQ5(final IhtcvirtualgipssolutionGipsAPI engine, final MappingConstraint constraint) {
	...
	protected List<Term> buildVariableLhs(final AgeGroupsInRoomMapping context) {
		...
		terms.add(new Term(engine.getNonMappingVariable(context, "DisjunctMappingConstraint42OnageGroupsInRoom_symbolic1"), 1.0));
		terms.add(new Term(engine.getNonMappingVariable(context, "MappingConstraint44OnageGroupsInRoom_EQslack2"), builder_0(context)));
		return terms;
	}
