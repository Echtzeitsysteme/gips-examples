...
public class MappingConstraint48OnageGroupsInRoom_EQ6 extends GipsMappingConstraint<IhtcvirtualgipssolutionGipsAPI, AgeGroupsInRoomMapping>{
	public MappingConstraint48OnageGroupsInRoom_EQ6(final IhtcvirtualgipssolutionGipsAPI engine, final MappingConstraint constraint) {
	...
	protected List<Term> buildVariableLhs(final AgeGroupsInRoomMapping context) {
		...
		terms.add(new Term(engine.getNonMappingVariable(context, "MappingConstraint48OnageGroupsInRoom_EQslack1"), 1.0));
		terms.add(new Term(engine.getNonMappingVariable(context, "MappingConstraint48OnageGroupsInRoom_EQslack2"), 1.0));
		terms.add(new Term(engine.getNonMappingVariable(context, "DisjunctMappingConstraint46OnageGroupsInRoom_symbolic1"), builder_0(context)));
		return terms;
	}
