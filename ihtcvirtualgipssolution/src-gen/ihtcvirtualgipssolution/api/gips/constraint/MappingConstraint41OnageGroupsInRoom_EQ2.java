...
public class MappingConstraint41OnageGroupsInRoom_EQ2 extends GipsMappingConstraint<IhtcvirtualgipssolutionGipsAPI, AgeGroupsInRoomMapping>{
	public MappingConstraint41OnageGroupsInRoom_EQ2(final IhtcvirtualgipssolutionGipsAPI engine, final MappingConstraint constraint) {
	...
	protected List<Term> buildVariableLhs(final AgeGroupsInRoomMapping context) {
		...
		terms.add(new Term(engine.getNonMappingVariable(context, "MappingConstraint41OnageGroupsInRoom_EQslack2"), builder_1(context)));
		return terms;
	}
