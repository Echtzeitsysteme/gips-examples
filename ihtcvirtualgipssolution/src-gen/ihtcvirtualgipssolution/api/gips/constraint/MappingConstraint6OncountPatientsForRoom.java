...
public class MappingConstraint6OncountPatientsForRoom extends GipsMappingConstraint<IhtcvirtualgipssolutionGipsAPI, CountPatientsForRoomMapping>{
	public MappingConstraint6OncountPatientsForRoom(final IhtcvirtualgipssolutionGipsAPI engine, final MappingConstraint constraint) {
	...
	protected void builder_0(final List<Term> terms, final CountPatientsForRoomMapping context) {
		...
		.forEach(elt -> {
			terms.add(new Term(elt, (double)((1000) * (-1.0)) * (1.0)));
		});
	}
}
