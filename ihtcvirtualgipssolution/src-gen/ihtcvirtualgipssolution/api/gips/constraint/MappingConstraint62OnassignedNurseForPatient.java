...
public class MappingConstraint62OnassignedNurseForPatient extends GipsMappingConstraint<IhtcvirtualgipssolutionGipsAPI, AssignedNurseForPatientMapping>{
	public MappingConstraint62OnassignedNurseForPatient(final IhtcvirtualgipssolutionGipsAPI engine, final MappingConstraint constraint) {
	...
	protected double builder_1(final AssignedNurseForPatientMapping context) {
		return (-1.0) * ((1.0) * (1000));
	}
}
