...
public class DisjunctMappingConstraint39OnageGroupsInRoom extends GipsMappingConstraint<IhtcvirtualgipssolutionGipsAPI, AgeGroupsInRoomMapping>{
	public DisjunctMappingConstraint39OnageGroupsInRoom(final IhtcvirtualgipssolutionGipsAPI engine, final MappingConstraint constraint) {
	...
	protected List<Term> buildVariableLhs(final AgeGroupsInRoomMapping context) {
		...
		terms.add(new Term(engine.getNonMappingVariable(context, "DisjunctMappingConstraint39OnageGroupsInRoom_symbolic1"), 1.0));
