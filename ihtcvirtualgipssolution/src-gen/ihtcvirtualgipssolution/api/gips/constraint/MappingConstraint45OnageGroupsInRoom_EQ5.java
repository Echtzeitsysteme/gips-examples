...
public class MappingConstraint45OnageGroupsInRoom_EQ5 extends GipsMappingConstraint<IhtcvirtualgipssolutionGipsAPI, AgeGroupsInRoomMapping>{
	public MappingConstraint45OnageGroupsInRoom_EQ5(final IhtcvirtualgipssolutionGipsAPI engine, final MappingConstraint constraint) {
	...
	protected List<Term> buildVariableLhs(final AgeGroupsInRoomMapping context) {
		...
		terms.add(new Term(engine.getNonMappingVariable(context, "MappingConstraint45OnageGroupsInRoom_EQslack2"), builder_0(context)));
		return terms;
	}
