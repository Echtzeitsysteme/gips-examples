...
public class MappingConstraint50OnageGroupsInRoom_EQ6 extends GipsMappingConstraint<IhtcvirtualgipssolutionGipsAPI, AgeGroupsInRoomMapping>{
	public MappingConstraint50OnageGroupsInRoom_EQ6(final IhtcvirtualgipssolutionGipsAPI engine, final MappingConstraint constraint) {
	...
	protected List<Term> buildVariableLhs(final AgeGroupsInRoomMapping context) {
		...
		terms.add(new Term(engine.getNonMappingVariable(context, "MappingConstraint50OnageGroupsInRoom_EQslack1"), 1.0));
		terms.add(new Term(engine.getNonMappingVariable(context, "MappingConstraint50OnageGroupsInRoom_EQslack2"), 1.0));
		terms.add(new Term(engine.getNonMappingVariable(context, "DisjunctMappingConstraint49OnageGroupsInRoom_symbolic0"), builder_0(context)));
		return terms;
	}
