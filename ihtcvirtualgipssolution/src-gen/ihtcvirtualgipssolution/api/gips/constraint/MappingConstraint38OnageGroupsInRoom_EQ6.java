...
public class MappingConstraint38OnageGroupsInRoom_EQ6 extends GipsMappingConstraint<IhtcvirtualgipssolutionGipsAPI, AgeGroupsInRoomMapping>{
	public MappingConstraint38OnageGroupsInRoom_EQ6(final IhtcvirtualgipssolutionGipsAPI engine, final MappingConstraint constraint) {
	...
	protected List<Term> buildVariableLhs(final AgeGroupsInRoomMapping context) {
		...
		terms.add(new Term(engine.getNonMappingVariable(context, "MappingConstraint38OnageGroupsInRoom_EQslack1"), 1.0));
		terms.add(new Term(engine.getNonMappingVariable(context, "MappingConstraint38OnageGroupsInRoom_EQslack2"), 1.0));
		terms.add(new Term(engine.getNonMappingVariable(context, "DisjunctMappingConstraint36OnageGroupsInRoom_symbolic1"), builder_0(context)));
		return terms;
	}
