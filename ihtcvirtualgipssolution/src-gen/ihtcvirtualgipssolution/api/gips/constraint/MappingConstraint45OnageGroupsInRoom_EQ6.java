...
public class MappingConstraint45OnageGroupsInRoom_EQ6 extends GipsMappingConstraint<IhtcvirtualgipssolutionGipsAPI, AgeGroupsInRoomMapping>{
	public MappingConstraint45OnageGroupsInRoom_EQ6(final IhtcvirtualgipssolutionGipsAPI engine, final MappingConstraint constraint) {
	...
	protected List<Term> buildVariableLhs(final AgeGroupsInRoomMapping context) {
		...
		terms.add(new Term(engine.getNonMappingVariable(context, "MappingConstraint45OnageGroupsInRoom_EQslack1"), 1.0));
		terms.add(new Term(engine.getNonMappingVariable(context, "MappingConstraint45OnageGroupsInRoom_EQslack2"), 1.0));
		terms.add(new Term(engine.getNonMappingVariable(context, "DisjunctMappingConstraint42OnageGroupsInRoom_symbolic2"), builder_0(context)));
		return terms;
	}
