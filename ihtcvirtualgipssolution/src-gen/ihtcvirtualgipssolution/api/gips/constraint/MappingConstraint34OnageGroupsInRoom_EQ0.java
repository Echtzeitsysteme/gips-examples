...
public class MappingConstraint34OnageGroupsInRoom_EQ0 extends GipsMappingConstraint<IhtcvirtualgipssolutionGipsAPI, AgeGroupsInRoomMapping>{
	public MappingConstraint34OnageGroupsInRoom_EQ0(final IhtcvirtualgipssolutionGipsAPI engine, final MappingConstraint constraint) {
	...
	protected List<Term> buildVariableLhs(final AgeGroupsInRoomMapping context) {
		...
		terms.add(new Term(engine.getNonMappingVariable(context, "MappingConstraint34OnageGroupsInRoom_EQslack1"), builder_1(context)));
		return terms;
	}
