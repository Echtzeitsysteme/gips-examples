...
public class MappingConstraint33OnageGroupsInRoom_EQ1 extends GipsMappingConstraint<IhtcvirtualgipssolutionGipsAPI, AgeGroupsInRoomMapping>{
	public MappingConstraint33OnageGroupsInRoom_EQ1(final IhtcvirtualgipssolutionGipsAPI engine, final MappingConstraint constraint) {
	...
	protected List<Term> buildVariableLhs(final AgeGroupsInRoomMapping context) {
		...
		terms.add(new Term(engine.getNonMappingVariable(context, "MappingConstraint33OnageGroupsInRoom_EQslack1"), builder_0(context)));
		return terms;
	}
