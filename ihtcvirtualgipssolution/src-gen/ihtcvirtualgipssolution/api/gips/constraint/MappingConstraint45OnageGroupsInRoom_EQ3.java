...
public class MappingConstraint45OnageGroupsInRoom_EQ3 extends GipsMappingConstraint<IhtcvirtualgipssolutionGipsAPI, AgeGroupsInRoomMapping>{
	public MappingConstraint45OnageGroupsInRoom_EQ3(final IhtcvirtualgipssolutionGipsAPI engine, final MappingConstraint constraint) {
	...
	protected List<Term> buildVariableLhs(final AgeGroupsInRoomMapping context) {
		...
		terms.add(new Term(engine.getNonMappingVariable(context, "MappingConstraint45OnageGroupsInRoom_EQslack2"), builder_1(context)));
		return terms;
	}
	...
	protected void builder_0(final List<Term> terms, final AgeGroupsInRoomMapping context) {
		...
		indexer.getMappingsOfNodes(Set.of(context.getR(), context.getD(), context.getAg())).parallelStream()
