...
public class MappingConstraint35OnageGroupsInRoom_EQ5 extends GipsMappingConstraint<IhtcvirtualgipssolutionGipsAPI, AgeGroupsInRoomMapping>{
	public MappingConstraint35OnageGroupsInRoom_EQ5(final IhtcvirtualgipssolutionGipsAPI engine, final MappingConstraint constraint) {
	...
	protected List<Term> buildVariableLhs(final AgeGroupsInRoomMapping context) {
		...
		terms.add(new Term(engine.getNonMappingVariable(context, "DisjunctMappingConstraint32OnageGroupsInRoom_symbolic2"), 1.0));
		terms.add(new Term(engine.getNonMappingVariable(context, "MappingConstraint35OnageGroupsInRoom_EQslack2"), builder_0(context)));
		return terms;
	}
