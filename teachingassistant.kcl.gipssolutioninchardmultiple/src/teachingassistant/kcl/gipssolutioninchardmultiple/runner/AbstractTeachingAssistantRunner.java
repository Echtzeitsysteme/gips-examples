...
public abstract class AbstractTeachingAssistantRunner {
	 ...
	 */
	protected void gipsSave(final GipssolutioninchardmultipleGipsAPI gipsApi, final String path) {
		try {
	 ...
	 */
	protected double buildAndSolve(final GipssolutioninchardmultipleGipsAPI gipsApi) {
	 ...
	 *                information from.
	 */
	protected void applySolution(final GipssolutioninchardmultipleGipsAPI gipsApi) {
