...
import teachingassistant.kcl.gipssolutionaltincswap.api.gips.GipssolutionaltincswapGipsAPI;
...
public abstract class AbstractTeachingAssistantRunner {
	 ...
	 */
	protected void gipsSave(final GipssolutionaltincswapGipsAPI gipsApi, final String path) {
		try {
	 ...
	 */
	protected double buildAndSolve(final GipssolutionaltincswapGipsAPI gipsApi) {
